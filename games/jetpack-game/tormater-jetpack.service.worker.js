...
/** @type {string} */
const CACHE_VERSION = '1775991240|902175619';
/** @type {string} */
const CACHE_PREFIX = 'Tormater Jetpack-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'tormater-jetpack.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["tormater-jetpack.html","tormater-jetpack.js","tormater-jetpack.offline.html","tormater-jetpack.audio.worklet.js","tormater-jetpack.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["tormater-jetpack.wasm","tormater-jetpack.pck"];
